...
const addService = props => {
  ...
  const uploadServiceDetail = () => {
    if (selectSport == 'Select') {
      ...
      dispatch(addServiceDetail(token, data, props.navigation, 1));
    }
  };
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View style={styles.subContainer}>
            ...
            <VirtualCard
              title="Check if this is a Virtual Online Service"
              value={isVirtual}
              onClick={getVirtual.bind(this)}
            />

            <View style={{ width: wp('80'), alignItems: 'center', marginTop: 10 }}>
              <Text style={[styles.h3, { marginTop: 10, marginBottom: Platform.OS == 'android' ? 8 : 10, }]}>About Your Staff</Text>
              <MyTextinputMultiline
