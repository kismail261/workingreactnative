...
const editEventDetail = props => {
  ...
  const uploadServiceDetail = () => {
    if (selectSport == 'Select') {
      ...
      axios
        .put(`${Url}api/listing/service/${listId}`, data, {headers: headers})
        .then(resp => {
          let response = resp.data;
          showMessage('Record updated!', 'warning');
          dispatch(setLoader(false));
          props.navigation.navigate('editParticularsEvents', {
            recordId: listId,
          });
        ...
        <ScrollView
          ...
          <View style={styles.subContainer}>
            ...
            <Text style={styles.subHeading}>
              Please tell us about your event. The more information you provide,
            ...
            />
            <View
              style={{width: wp('80'), alignItems: 'center', marginTop: 10}}>
            ...
            <View
              style={{width: wp('80'), alignItems: 'center', marginTop: 10}}>
              <Text style={[styles.h3, {marginTop: 10}]}>What's Included</Text>
              <MyTextinputMultiline
                placeholderTextColor={styles.placeholderStyle}
            ...
            <View
              style={{width: wp('80'), alignItems: 'center', marginTop: 10}}>
              <Text style={[styles.h3, {marginTop: 10}]}>The Event Venue</Text>
              <MyTextinputMultiline
