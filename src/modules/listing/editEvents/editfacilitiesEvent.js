...
const facilities = (props) => {
    ...
    const addFacilities = () => {
        if (facilitiesRes.length == 0) {
            ...
            dispatch(editServiceFacilities(token, recordId, data, props.navigation, 2))
        }
    }
            ...
            <View style={styles.container} >
                ...
                <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                    <View style={styles.subContainer} >
                        ...
                        <CustomTitleDropdown item={Facilities} value={facilitiesRes} label="What Facilities are used for this event?" placeHolder="Select Facilities" getValue={getFacilities.bind(this)} />
