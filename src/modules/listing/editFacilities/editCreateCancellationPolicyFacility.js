...
const createCancellationPolicy = (props) => {
    ...
    const savePolicy = () => {
        if (days == '') {
            showMessage("Days field should not be blank", 'warning')
        } else {
            ...
            dispatch(addPolicy(token, recordId, data, props.navigation, 3))
            props.navigation.navigate("editCancellationPolicyFacilty", { recordId: recordId })
        }
    }
        ...
        <View style={styles.container} >
            ...
            <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                <View style={styles.subContainer} >
                    ...
                    <Text style={styles.subHeading} >Please enter the number of days for your own cancellation and refund policy that works bestfor your facility</Text>
