...
const frequentlyQuestions = props => {
    ...
    const saveQuestion = () => {
        if (question == '') {
            ...
            dispatch(addFrequentlyAskedQuestions(token, recordId, data, props.navigation, 3));
            setQuestion('');
            setAnswer('');
        }
    };
        ...
        <View style={styles.container}>
            ...
            <ScrollView
                ...
                <View style={styles.subContainer}>
                    ...
                    <Btn
                        label="Continue"
                        onClick={() => props.navigation.navigate('editCancellationPolicyFacilty', {
                            recordId: recordId,
                        })}
                        bgColor="#2C99C6"
                    />
                    ...
                    <TouchableOpacity
                        onPress={() =>
                            props.navigation.navigate('editCancellationPolicyFacilty', {
                                recordId: recordId,
                            })
                        }>
