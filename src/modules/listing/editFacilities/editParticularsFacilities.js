...
const addParticulars = props => {
  ...
  useEffect(() => {
    setResponseGood(resposneGoodFor);
  }, [resposneGoodFor]);
  ...
  const uploadServiceParticulars = () => {
    if (gender == '') {
      ...
      dispatch(
        editServiceParticulars(token, recordId, data, props.navigation, 3),
      );
    }
  };
      ...
      <ScrollView
        ...
        <View style={styles.subContainer}>
          ...
          <Text style={styles.subHeading}>
            Add some particulars to describe who the facility is most suited to,
            and help Users choose what's best for.
          </Text>
          <View>
