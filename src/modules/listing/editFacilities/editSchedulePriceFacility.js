...
const schedulePrice = props => {
  ...
  const continueClick = () => {
    if (scheduleList.length == 0) {
      ...
      props.navigation.navigate('editInsuranceRequirements', {
        recordId: recordId,
      });
    }
  };
        ...
        <ScrollView
          ...
          <View style={styles.subContainer}>
            ...
            <Text style={styles.subHeading}>
              Enter the dates, days, times, and other particulars for your
              facility
            </Text>
            <Text style={styles.subHeading1}>
              You have the option to add multiple schedules for your facility,
              using different dates, days, and times
            </Text>
            <Text style={styles.subHeading1}>
              Note: If your facility has multiple locations, then a new listing
            ...
            <View style={{width: wp('80'), marginTop: 12}}>
              ...
              <Text style={[styles.subHeading1, {fontSize: wp('3')}]}>
                This is the date that your facilities start
              </Text>
              <CustomDatePicker
                value={startDate}
            ...
            <View style={{width: wp('80'), marginTop: 12}}>
              ...
              <Text style={[styles.subHeading1, {fontSize: wp('3')}]}>
                This is the date that your facilities end
              </Text>
              <CustomDatePicker
                value={endDate}
            ...
            {repeatRadio == 'No' ? null : (
              <>
                <View
                  ...
                  <View>
                    <Text
                      style={[styles.labelStyle, {width: wp('37.5')}]}></Text>
                    <NativePicker
                      placeHolder="select"
                      data={repeatData}
            ...
            <View
              ...
              <View>
                <Text style={[styles.labelStyle, {width: wp('25')}]}>
                  Price
                </Text>
                <TextInput
                  style={{
            ...
            <View style={{width: wp('80'), marginTop: 12}}>
              <Text style={styles.labelStyle}>
                Do you want to add a Preparation fee?
              </Text>
              <Text style={[styles.subHeading1, {fontSize: wp('3')}]}>
                Set the preparation fee for your facility
              </Text>
              <RadioForm
            ...
            <View style={{width: wp('80'), marginTop: 12}}>
              <Text style={styles.labelStyle}>
                Do you want to add Custodial Staff fee?
              </Text>
              <Text style={[styles.subHeading1, {fontSize: wp('3')}]}>
                Set the custodial fee for your facility
              </Text>
              <RadioForm
                radio_props={monthlyPay}
                initial={1}
            ...
            <View style={{width: wp('80'), marginTop: 12}}>
              <Text style={styles.labelStyle}>
                Do you want to collect a security and damage deposit?
              </Text>
              <Text style={[styles.subHeading1, {fontSize: wp('3')}]}>
                Enter the Security and Damage deposit
              </Text>
              <RadioForm
                radio_props={monthlyPay}
                initial={1}
