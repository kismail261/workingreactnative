...
const editParticulars = props => {
  ...
  const [resposneGoodFor, setResponseGood] = useState([]);
  ...
  const getListingDetail = () => {
    ...
    axios
      ...
      .then(resp => {
        ...
        setResponseGood(response.goodfor);
  ...
  const uploadServiceParticulars = () => {
    if (gender == '') {
    ...
    } else if (resposneGoodFor.length == 0) {
      ...
      dispatch(
        editServiceParticulars(token, recordId, data, props.navigation, 1),
      );
    }
  };
          ...
          <ScrollView
            ...
            <View style={styles.subContainer}>
              ...
              <Text style={styles.subHeading}>
                Add some particulars to describe who the service is most suited
                to, and help Users choose what's best for them.
              </Text>
              <View>
                <Text style={[styles.labelStyle, {width: wp('80')}]}>
                  Gender
                </Text>
