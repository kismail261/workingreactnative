...
import Header1 from '../components/data/Header1';
...
const editSchedulePrice = props => {
  ...
  const continueClick = () => {
    if (scheduleList.length == 0) {
      ...
      props.navigation.navigate('editFrequentlyQuestions', {
        recordId: recordId,
      });
    }
  };
  console.log('schdule', scheduleList);
  return (
...
export default editSchedulePrice;
