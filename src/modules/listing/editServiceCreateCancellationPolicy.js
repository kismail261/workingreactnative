...
const editServiceCreateCancellationPolicy = props => {
  ...
  const savePolicy = () => {
    if (days == '') {
      ...
      showMessage('Detail field should not be blank', 'warning');
    } else {
      ...
      const response = await fetch(
        `http://sfyapi.herokuapp.com/api/listing/cancel/${recordId}`,
        {
          method: 'PUT',
          headers: {
      ...
      <ScrollView
        ...
        <View style={styles.subContainer}>
          ...
          <Text style={styles.subHeading}>
            Enter the number of days that works best for your Cancellation
            Policy
          </Text>
