...
const facilities = (props) => {
    ...
    const addFacilities = () => {
        if (facilities.length == 0) {
            ...
            dispatch(addServiceFacilities(token, recordId, data, props.navigation, 1))
        }
    }
            ...
            <View style={styles.container} >
                ...
                <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                    <View style={styles.subContainer} >
                        ...
                        <CustomTitleDropdown item={Facilities} value={facilities} label="What Facilities are used for this service?" placeHolder="Select Facilities" getValue={getFacilities.bind(this)} />
