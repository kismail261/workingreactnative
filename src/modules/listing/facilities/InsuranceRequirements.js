...
import { addInsurance } from '../../../redux/listing/listing.action';
...
const InsuranceRequirements = props => {
    ...
    const saveInsurance = () => {
        if (answer == '') {
            showMessage('Insurance Particulars field should not be blank');
        } else {
            dispatch(setLoader(true));
            let data = {
                insurance: answer
            };
            dispatch(addInsurance(token, recordId, data, props.navigation));
        }
    };
            ...
            <ScrollView
                ...
                <View style={styles.subContainer}>
                    ...
                    <View style={{ width: wp('80'), alignItems: 'center', marginTop: 10 }}>
                        <Text style={[styles.h3, { marginTop: 10, marginBottom: Platform.OS == 'android' ? 8 : 10, }]}>Insurance Particulars</Text>
                    ...
                    <View
                        ...
                        <TouchableOpacity onPress={() => setCertify(!certify)} style={{ width: '93%' }}>
