...
const addFacilites = (props) => {
    ...
    const uploadServiceDetail = () => {
        if (selectSport == 'select') {
            ...
            showMessage("Should select facility type")
        } else if (serviceName == '') {
            showMessage("Facility title field should not be blank")
        } else if (serviceDesc == '') {
            showMessage("Facility Description field should not be blank")
        } else if (whatsIncluded == '') {
            showMessage("Special conditions field should not be blank")
