...
import { addServiceFacilitiesAmenties } from '../../../redux/listing/listing.action'
...
const facilities = (props) => {
    ...
    const addFacilities = () => {
        if (facilities.length == 0) {
            showMessage("Should select facilities")
        } else if (amenties.length == 0) {
            showMessage("Should select amenties")
        } else if (equipment.length == 0) {
            showMessage("Should select equipment")
        } else if (preparation == '') {
            showMessage("Preparation field should not be blank")
        } else {
            ...
            dispatch(addServiceFacilitiesAmenties(token, recordId, data, props.navigation, 3))
        }
    }
            ...
            <View style={styles.container} >
                ...
                <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                    <View style={styles.subContainer} >
                        ...
                        <CustomTitleDropdown item={Facilities} value={facilities} label="What Facilities are used for this facility?" placeHolder="Select Facilities" getValue={getFacilities.bind(this)} />
                        ...
                        <CustomTitleDropdown item={EquipmentType} value={equipment} label="What Equipment is available and included at this facility?" placeHolder="Select Equipment" getValue={getEquipment.bind(this)} />
