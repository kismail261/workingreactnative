...
const addParticulars = (props) => {
    ...
    const getToDate = (value) => {
        if (fromDate > value) {
            showMessage("Age To value should be greater than Age From");
            setToDate(value);
        } else {
            setToDate(value);
        }
    ...
    const uploadServiceParticulars = () => {
        if (gender == 'Select') {
            showMessage("Should select gender")
        } else if (fromDate == 0) {
            showMessage("Should select Age From")
        } else if (toDate == 0) {
            showMessage("Should select Age To")
