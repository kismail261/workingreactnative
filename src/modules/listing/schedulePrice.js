...
const schedulePrice = props => {
  ...
  const saveSchedulePrice = (isContinue) => {
    ...
    if (serviceName == '') {
      ...
      if (isContinue) props.navigation.navigate('frequentlyQuestions', { recordId: recordId });
      else {
    ...
    let data = [
      {
        ...
        repeatCount: schedule.repeat.isRepeat
          ? schedule.repeat.repeatEvery.count
          : '',
        repeatType: schedule.repeat.isRepeat
          ? schedule.repeat.repeatEvery.period
          : '',
  ...
  const onCloseHeader = () => {
    props.navigation.navigate('listingTypes');
  }
    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <View style={styles.subContainer}>
              ...
              <View
                ...
                <View>
                  ...
                  <NativePicker
                    placeHolder="select"
                    data={repeatData}
                    getValue={getRepeatType.bind(this)}
                    size={'37.5'}
                  />
                </View>
              </View>
          ...
          <View
            ...
            <View>
              ...
              <NativePicker
                ...
                data={perData}
                value={pricePer}
                getValue={getPerPerson.bind(this)}
                size={'30'}
              />
            </View>
          </View>
          ...
          <TouchableOpacity
            onPress={() => saveSchedulePrice(false)}
            style={{
              width: wp('80'),
              height: 46,
              borderColor: '#61B2D4',
