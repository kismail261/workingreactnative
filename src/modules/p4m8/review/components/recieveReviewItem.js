...
const recieveReviewItem = ({ navigation, detail }) => {
    ...
    const onClick = () => {
        ...
        setTimeout(() => {
            ...
            showMessage("Requested for review from provider")
        }, 150);
    }
    ...
    return (
        <View style={styles.container} >
            ...
            <TouchableOpacity onPress={onClick} style={{ width: '100%', height: 30, alignItems: 'center', justifyContent: 'center', borderTopColor: '#15488F26', borderTopWidth: 1 }}>
                <Text style={styles.takingStyle} >Ask for Review</Text>
            </TouchableOpacity>
        </View>
    )
}

export default recieveReviewItem
