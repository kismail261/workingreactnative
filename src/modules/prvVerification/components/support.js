  ...
  return (
    <ScrollView >
      <View style={styles.container} >
        ...
        <Text style={styles.boldSubHeading}>
         <Text style={{fontSize:60,color:'#2C99C6'}}>.</Text> Upload an existing photo of your ID
        </Text>
        <Text style={styles.boldSubHeading}>
        <Text style={{fontSize:60,color:'#2C99C6'}}>.</Text> Add your legal first and last name, and last  4 digits of your SSN
        </Text>
        <Text style={styles.boldSubHeading}>
         <Text style={{fontSize:60,color:'#2C99C6'}}>.</Text> Add your address (this should match<Text> where you get banking documents or utility bills)</Text> 
        </Text>
        <Text style={styles.subHeading}> Completing this process isn't an
          endorsement of any Provider or User, a
          guarantee of someone's identity, or an
          assurance that interacting with them will be
          safe. Always use your own best judgment,
          and follow our safety tips for Users and
          Providers</Text>
