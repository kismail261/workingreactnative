...
export const SportsExplore = props => {
  ...
  const getAllProviders = async () => {
    ...
    try {
      let res = axios.post(`${Url}api/users/providerinfo`);
      console.log(res);
    } catch (error) {
      console.log(error);
    }
      ...
      <ExploreEventCard
        ...
        onPress={() =>
          props.navigation.navigate(
            token != null ? 'SportsEvents' : 'authRoute',
          )
        }
      />
    );
  ...
  const e1 = [
    ...
    },
    {
      name: 'Golf',
      listings: '13',
      img: require('../../../assets/images/golf.png'),
    },
    {
      name: 'Basketball',
      listings: '22',
      img: require('../../../assets/images/bascketBall.png'),
    },
    {
      name: 'Football',
      listings: '05',
  ...
  const e2 = [
    {
      name: 'Cycling',
      listings: '30',
      img: require('../../../assets/images/cycling.png'),
    },
    {
      name: 'Baseball',
      listings: '13',
      img: require('../../../assets/images/volleyball.png'),
    },
    {
      name: 'Running',
      listings: '22',
  ...
  const e3 = [
    {
      name: 'Tennis',
      listings: '30',
      img: require('../../../assets/images/tannis.png'),
    },
    {
      name: 'Softball',
      listings: '13',
      img: require('../../../assets/images/baseball.png'),
    },
    {
      name: 'Yoga',
      listings: '22',
      img: require('../../../assets/images/ypga.png'),
    },
    {
      name: 'Running',
      listings: '05',
      img: require('../../../assets/images/runner.png'),
    },
  ];
  ...
  return (
    <SafeAreaView style={styles.main}>
      {token != null ? (
        <Header navigation={props.navigation} pageName={'SportsExplore'} />
      ) : (
        <></>
      )}
